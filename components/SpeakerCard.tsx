        ...
        <div className="grid grid-cols-1 gap-1.5">
          {AVAILABLE_VOICES.map((voice) => (
            <button
              ...
              className={`flex items-center justify-between p-2 border transition-all duration-200 relative overflow-hidden ${
            ...
            >
              ...
              <span className={`text-[9px] px-1.5 py-0.5 border uppercase font-bold z-10 ${
                  speaker.voiceName === voice.name ? 'border-cyan-500/50 text-cyan-400' : 'border-gray-800 text-gray-700'
              }`}>
