...
const App: React.FC = () => {
  ...
  const togglePlayback = () => {
    ...
    if (isPlaying) {
      ...
      const resumeTime = pauseTimeRef.current > 0 ? pauseTimeRef.current : 0;
                        ...
                        <div className="flex flex-col gap-2">
                            {TTS_MODELS.map(model => (
                                <button
                                    ...
                                    className={`w-full py-2 px-3 text-[10px] font-bold uppercase tracking-widest transition-all border flex justify-between items-center ${
